-- | The forest automata is a nondeterministic cellular automata which simulates a forest fire
module Forest where
...
--   If a tree as at least one burning neighbor tree it starts to burn itself which probability `newFireProb`.
